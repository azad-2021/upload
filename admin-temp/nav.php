    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="index.html"><img src="assets/images/logo.webp" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="index.html"><img src="assets/images/logo.webp" alt="logo" /></a>
      </div>
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#AddSubject">Subject</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="auth">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="pages/samples/blank-page.html">Class Fees</a></li>
              <li class="nav-item"> <a class="nav-link" href="pages/samples/error-404.html">Class Subject</a></li>
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="" data-bs-toggle="modal" data-bs-target="#SubjectList">
            <span class="menu-icon">
              <i class="mdi mdi-chart-bar"></i>
            </span>
