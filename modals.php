  ...
  <div class="modal-dialog">
    <div class="modal-content rounded-corner">
      ...
      <div class="modal-body">
        ...
        <button type="button" class="btn btn-primary SearchStudent">Search</button>
      </div>
    </div>
  </div>
</div>
        ...
        <form align="center" method="POST" action="" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              <input type="number" class="form-control" name="SalaryAmount" required min="0" maxlength="16">
            </div>
            <div class="col-lg-3">
              <label for="recipient-name" class="col-form-label">Gender:</label>
              <br>
        ...
        <form align="center" id="SalaryForm">
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              <select class="form-control" id="StaffIDS">
                <option value="">Select</option>
                <?php 
              ...
              <div class="col-lg-3">
                <label for="recipient-name" class="col-form-label">Salary Amount</label>
                <input type="text" class="form-control" id="SalaryAmount" min="0" disabled="">
              </div>
              <div class="col-lg-3">
