  ...
  $Data="SELECT * from u241098585_college_demo.students
  join branchs on students.BranchID=branchs.BranchID WHERE StudentID=$userid";
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql="UPDATE u241098585_college_demo.students SET Email='$Email' WHERE StudentID=$userid";
  ...
  if (isset($_POST['submit2'])) {
    ...
    $sql="UPDATE u241098585_college_demo.students SET Password='$newPassword' WHERE StudentID=$userid";

    $Data="SELECT * from u241098585_college_demo.students WHERE StudentID=$userid and Password='$OldPassword'";
    $result=mysqli_query($con,$Data);
                ...
                <div class="card-body">
                  <form class="forms-sample" method="POST" action="">
                    <div class="form-group" style="align-items: center;">
                      ...
                      <input type="text" style="color:black;" class="form-control" name="Username" value="<?php echo $rowx['StudentName']; ?>" disabled required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Branch</label>
                      <input type="email" style="color:black;" class="form-control" name="Email1" value="<?php echo $rowx['BranchName']; ?>" disabled required>
                    </div>
